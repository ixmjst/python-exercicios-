...
print(f"Seu Nome:{nome}, e sua idade: {idade}.")
 # Calcular em  quantos anos a pessoa fará 100 anos . Mostre o resultado numa frase
print(f"Em {100-idade} fara 100 anos ")
#Crie variáveis com seu tipo: um texto (str), um inteiro (int), um decimal (float) e um
